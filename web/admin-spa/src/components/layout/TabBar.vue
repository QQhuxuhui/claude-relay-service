...
const tabs = computed(() => {
  const baseTabs = [
    ...
    { key: 'riskMonitor', name: '风险监控', shortName: '风险', icon: 'fas fa-shield-alt' }
  ]
  ...
  baseTabs.push(
    { key: 'rateMultipliers', name: '费率配置', shortName: '费率', icon: 'fas fa-percentage' },
    { key: 'qrCodes', name: 'QR Codes', shortName: 'QR', icon: 'fas fa-qrcode' },
